...
import '../../../css/admin/tempusdominus-bootstrap-4.min.css';
import '../../../css/admin/icheck-bootstrap.min.css';
import '../../../css/admin/jqvmap.min.css';

import '../../../css/admin/adminlte.min.css';
import '../../../css/admin/OverlayScrollbars.min.css';
import '../../../css/admin/daterangepicker.css';
import '../../../css/admin/summernote-bs4.css';
  ...
  <nav className="main-header navbar navbar-expand navbar-white navbar-light">
    <ul className="navbar-nav">
      ...
      <li className="nav-item d-none d-sm-inline-block">
        <a  className="nav-link">Site Web</a>
      </li>
      <li className="nav-item d-none d-sm-inline-block">
